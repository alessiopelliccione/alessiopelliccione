...
| Angular DevTools  | Fix: Ensure the content script forwards Angular detection results to the service worker so the popup/icon reflects the page state. | [PR #65210](https://github.com/angular/angular/pull/65210) | In review |
